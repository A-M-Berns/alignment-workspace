/-
  Vendored verbatim (module header aside) from the `lean-deference` corpus
  (`FaithfulAcceleration.lean`, note dump of 2026-06-27): the dose-response
  modules re-run this kernel-checked chain with the thinned weight
  (`dose-response.md` §5 / `ThinnedForcing`).
