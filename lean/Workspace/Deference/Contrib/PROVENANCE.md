...
| `LICorrigibility.lean` | `prompts/2026-09-15-li-corrigibility/` (executor: Claude Fable 5.1, Anthropic; prompt author: the maintainer) | `ci-only` | 2026-09-15 | `prompts/2026-09-15-li-corrigibility/` | — |
