/-
# `Workspace.Normativity` — namespace root

The normativity and answerability line. Empty of mathematics: this file exists so
the namespace is real and built, and so the first normativity round has somewhere
...
namespace Workspace.Normativity
