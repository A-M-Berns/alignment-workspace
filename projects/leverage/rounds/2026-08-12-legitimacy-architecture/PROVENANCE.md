...
|---|---|---|---|---|---|
| `README.md`, `THEOREM_MAP.md`, `PROSECUTION.md`, `MAPPING.md`, `FOR_HUMANS.md` | Claude Opus 5 (Anthropic) | `ci-only` | 2026-08-12 | `prompts/2026-08-12-legitimacy-reorganization/`; prompt author GPT-5.6 Sol (OpenAI) | — |
...
claims. Nothing in this round is in Lean: the execution environment had no Lean
toolchain, and the four port targets are filed as priorities items instead.
