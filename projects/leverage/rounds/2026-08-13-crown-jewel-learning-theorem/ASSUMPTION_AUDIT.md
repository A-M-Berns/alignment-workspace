...
| **H6** | coverage, `B_T(g) = o(M_T(g))` | STRUCTURAL HYPOTHESIS — the inquiry interface |
...
| — | `Q_T(g)/M_T(g) -> 0` under H6 | DERIVED NORMATIVE-LEARNING CONSEQUENCE |
| — | `E[N_T] = Q_T` | DERIVED, one line |
