...
- [`no-timely-pointwise-tower.md`](no-timely-pointwise-tower.md) — self-contained summary of
  ...
  synthesized with the positive result by [`../notes/pointwise-tower-and-faithful-acceleration.md`](../notes/pointwise-tower-and-faithful-acceleration.md).
...
- [`../notes/deference-in-logical-induction-v4.md`](../notes/deference-in-logical-induction-v4.md) —
