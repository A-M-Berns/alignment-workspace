...
Read `TARGET.md`, then `ATTACKS.md`, `CROSS_REVIEW_A.md`, `COUNTERMODELS.md`, and `REPORT.md`. Run
`python3 tests/run.py`; the Lean countermodels are in
`lean/Workspace/Normativity/Contrib/IntegrityAdversary.lean`.
