...
| 27u | a verified deficit certificate binds to the exact date, support, row presentation and live-world set; enumeration order is not operative and row order is | — | derived | same | yes | no |
