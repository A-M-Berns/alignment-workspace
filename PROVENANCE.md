...
| `projects/leverage/notes/NORMATIVE_LEARNING_INTERFACE*.md`, `projects/leverage/notes/PROVENANCE.md` | GPT-5 Codex (OpenAI) | `ci-only` | 2026-08-11 | `prompts/2026-08-11-normative-learning-interface/`; prompt author GPT-5.6 Sol (OpenAI). Organizational routing only; no scientific result or claim-status change |
| `prompts/2026-08-11-normative-learning-interface/**`, and the learning-track reconciliation in `PRIORITIES.md`, `RESEARCH_STATE.md`, and `projects/leverage/README.md` | GPT-5 Codex (OpenAI) | `ci-only` | 2026-08-11 | same. Items 32 and 33 were filed within the maintainer-dispatched scope; `DECISIONS.md`, deference, and the authoritative leverage consolidation are unchanged |
...
| `projects/deference/rounds/2026-08-12-time-indexed-corrective-capability/**`, `prompts/2026-08-12-time-indexed-corrective-capability/**`, `lean/Workspace/Deference/Contrib/TimeIndexedCapability.lean`, the `PRIORITIES.md` Q3 update, the `RESEARCH_STATE.md` time-index bar, and the `DISPATCH_QUEUE.md` return entry | Claude Opus 5 (Anthropic) | `ci-only` | 2026-08-12 | `prompts/2026-08-12-time-indexed-corrective-capability/`; prompt author GPT-5.6 Sol (OpenAI). A representation round returning **`Mixed`**. Its adversarial review ran in a **separate Claude Opus 5 context** and refuted two of three headline claims; all fourteen findings were accepted and the refutations are theorems in §10 of the Lean file rather than prose replies. **No claim registered, no item filed, Q3 not graduated, no source tree touched.** The Lean carries its own provenance entry in `lean/Workspace/Deference/Contrib/PROVENANCE.md`, which directs a reader to §10 before citing anything above it |
...
| `2026-08-12-time-indexed-corrective-capability` | GPT-5.6 Sol (OpenAI) | Claude Opus 5 (Anthropic) | 2026-08-12 |
